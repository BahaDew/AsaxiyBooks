...
class CategoryPdfByBooksAdapter :
    ListAdapter<BookUIData, CategoryPdfByBooksAdapter.CategoryByHolder>(CategoryByDiffUtil) {

    private var onClick: ((BookUIData) -> Unit)? = null
    private var time = System.currentTimeMillis()

    inner class CategoryByHolder(private val binding: ItemPdfBookByCategoryBinding) :
