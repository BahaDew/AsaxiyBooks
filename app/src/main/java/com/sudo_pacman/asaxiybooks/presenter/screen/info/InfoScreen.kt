...
import com.sudo_pacman.asaxiybooks.presenter.screen.intro.IntroScreenDirections
...
//        val bookData = navArgs.book
        ...
        binding.btnListen.setOnClickListener {
            findNavController().navigate(InfoScreenDirections.actionInfoScreenToAudioScreen())
        }
